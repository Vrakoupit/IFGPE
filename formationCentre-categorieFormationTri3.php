...
<div class="fildAriane">
	...
	<section class="titreCentre">
		...
		<div class="infoCatFormation">
			<?php include 'categorieFormationPage/IT&SM/ibm.php'; ?>
		</div>
	</section>
	<ul class="filtreFormation">
		...
		<li class="liFiltre"><a href="formationCentre-categorieFormationTri3.php" class="blockListFormation list-cat-3 activeCat">IBM</a></li>
	...
	<section class="listeFormation">
		<ul class="containerFormation">
			<li class="paslol">
				<h4>IBM - Titre de la formation</h4>
				<span class="catItem cat-3"></span>
				<ul class="col-sm-8">
